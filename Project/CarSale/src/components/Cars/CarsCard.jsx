...
const CarsCard = ({ id, img, name, price }) => {
    return (
        <div className="border-2 border-secondary bg-slate-100 text-black rounded-xl mb-2 cursor-pointor" key={id}>
            <img src={img} alt="img"></img>
            <h1 className='font-bold text-xl pl-5 text-primary'>{name}</h1>
            <p className='pl-5 pb-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
