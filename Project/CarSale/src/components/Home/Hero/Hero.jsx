    ...
    <div className='bg-black text-white'>
        <div className='h-screen container flex flex-col justify-center md:flex-row items-center'>
            ...
            <div className='w-full md:w-2/4 space-y-5 mt-10'>
                ...
                <p className='text-sm lg:text-base'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam corrupti praesentium minima pariatur inventore sit laudantium magni, dignissimos nulla distinctio mollitia quos sequi eaque doloremque sint dolorum eveniet unde consequatur.</p>
