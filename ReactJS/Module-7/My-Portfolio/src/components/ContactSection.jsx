                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 d-flex flex-column justify-content-center mx-auto">
                            <h2 className="mb-5 mx-auto">Contact Me</h2>
                            <p className="mx-auto">janvip4699@gmail.com</p>
                            <p className="mx-auto">8155810368</p>
                            <p className="mx-auto">Narmada park - 4, Near amin marg</p>
