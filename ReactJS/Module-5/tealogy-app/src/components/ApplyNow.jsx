        ...
        <>
            <div className="container w-50 p-2 bg-yellow-400 rounded-xl">
                ...
                <form>
                    ...
                    <div>
                    <input className="m-2 p-2 w-11/12 rounded-xl" type="text" placeholder="Contact Number*"></input>
                    </div>
                    <div className="flex flex-row">
                    ...
                    <div>
                    <input className="m-2 p-2 w-11/12 rounded-xl" type="text" placeholder="Your Budget*"></input>
                    </div>
                    <div>
                    <input className="m-2 p-2 w-11/12 rounded-xl" type="text" placeholder="Your Message*"></input>
                    </div>
