...
function Slider() {
    ...
    const Sliders = [
        {
            ...
            subtext: "Sign up for dail news letter"
        },
        {
    ...
    return (
        <>
            <div className="max-w-[1540px] w-full h-auto px-4 py-10 group">
                <div
                    style={{ backgroundImage: `url(${Sliders[currentIndex].url})` }}
                    className="w-full h-full rounded-2xl bg-center bg-cover transition-all duration-1000 ease-in-out"
                >
                    <div className="slider-heading ms-32 pt-48 w-[560px]"
                        style={{ filter: "brightness(1.5)" }}>
                        <h1 className="text-[60px] text-color duration-1000">
                            {Sliders[currentIndex].maintext}
                        </h1>
                        <h2 className="text-[30px] text-color duration-1000">
