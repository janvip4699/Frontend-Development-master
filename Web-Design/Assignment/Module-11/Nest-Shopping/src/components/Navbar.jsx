            ...
            <div className="flex flex-row justify-between py-2 border-b-2" id="navbar">
                ...
                <div className="mx-3 py-4 me-64">
                    <ul className="list-none flex flex-row text-gray-600 text-md font-semibold">
                        ...
                        <ul  className="group-hover:flex flex-col animation-menu-transition duration-300 border-2 bg-white hidden absolute w-50 -translate-x-23 translate-y-14">
                                <li className="mx-auto hover:bg-slate-200 py-1 px-10"><label>Dashboard</label></li>
                                <li className="mx-auto hover:bg-slate-200 py-1 px-10">Store Listing</li>
                                <li className=" hover:bg-slate-200 py-1 px-10">Store Details</li>
                                <li className=" hover:bg-slate-200 py-1 px-10">My Orders</li>
                            </ul>
                        </li>
